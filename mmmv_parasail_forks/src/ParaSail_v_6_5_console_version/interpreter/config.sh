...
if ! test -L psc-interpreter-locks.ads; then
   case $1 in
    "on")
        ln -s psc-interpreter-locks-omp.ads psc-interpreter-locks.ads
        ln -s psc-interpreter-locks-omp.adb psc-interpreter-locks.adb
        echo "Config: OMP locks enabled"
        ;;

     *) ln -s psc-interpreter-locks-po.ads psc-interpreter-locks.ads
        ln -s psc-interpreter-locks-po.adb psc-interpreter-locks.adb

...
package body PSC.Interpreter.Builtins is
   ...
   --  Print value of Param 0 as a string and (optionally) give a traceback.
   ...
   --  Print value of Param 0 as a string and (optionally) give a traceback.
   begin
      Print_Univ_Enum (Context, Params, Static_Link);

      raise Ada.Assertions.Assertion_Error;  --  TBD: Give traceback
   end Runtime_Message;
   ...
   begin
      Store_Word (Params, 0, Univ_Strings.To_Word_Type
        (Univ_Strings.From_U_String
          (Strings.To_U_String
             (Strings.U_String_Index (Fetch_Word (Params, 1))),
           Target)));
   end To_String_Enum;
   ...
   begin
      Store_Word
        (Params, 0,
         To_Word_Type
            (From_String
                (Word_To_String (Fetch_Nonnull_Word (Params, 1)) &
                   Word_To_String (Fetch_Nonnull_Word (Params, 2)),
                Target,
      ...
      Store_Word
        (Params, 0,
         Univ_Strings.To_Word_Type
            (Univ_Strings.From_String
                (Word_To_String (Fetch_Nonnull_Word (Params, 1)) &
                   Character'Val (Fetch_Word (Params, 2)),
                 Target,
                 Context.Server_Index)));
   end Concat_Char;
   ...
   begin
      Univ_Strings.Assign_Concat_String
        (Str_Ptr => Target_Ptr,
         New_String => (1 => Character'Val (Fetch_Word (Params, 1))),
         Server_Index => Context.Server_Index);
   ...
   begin
      Store_Word
        (Params, 0,
         To_Word_Type
            (From_String
                (Character'Val (Fetch_Word (Params, 1)) &
                   Word_To_String (Fetch_Nonnull_Word (Params, 2)),
                 Target,
                 Context.Server_Index)));
   end Concat_Char_Str;
...
begin
   ...
   Register_Builtin
     (String_Lookup ("#runtime_message"), Runtime_Message'Access);

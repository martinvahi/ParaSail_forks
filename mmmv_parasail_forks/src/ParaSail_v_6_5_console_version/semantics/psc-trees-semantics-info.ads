...
private package PSC.Trees.Semantics.Info is
   ...
   --  or an operation name.
      ...
      Reported_As_Undefined : Boolean := False;
      --  This is set True when this opnd reported as having no interpretations
   end record;
   ...
   with
      ...
      --  Op_Sem field points to "=?" operator
         ...
         Loop_Result_Local_Offset : Interpreter.Offset_Within_Area := 0;

...
package body PSC.Trees.Semantics.Translator is
   ...
   procedure Instruction_Num_Params
     (Context : Exec_Context;
      Params : Word_Ptr;
      Static_Link : Non_Op_Map_Type_Ptr);
   pragma Export (Ada, Instruction_Num_Params, "_psc_instruction_Num_Params");
   ...
   pragma Export (Ada, Type_Desc_Null_Value_For_Type,
      "_psc_type_desc_null_value_for_type");
   ...
   begin
      if Val = Null_Value then
         ...
         return Addr_To_Type_Descriptor_Ptr
   ...
   begin
      ...
      Store_Word (Params, 0, PFS.Local_String_Index'Pos (Result));
   ...
   begin
      Store_Word (Params, 0,
        PFS.Local_String_Index'Pos (PFS.Num_Strings (PFST)));
   end PFS_Num_Elems;
   ...
   begin
      Store_Word
        (Params, 0,
         Symbols.Sym_Index'Pos (Symbols.Num_Prior_Homonyms
   ...
   begin
      if Locator.Base /= Const_Area then
         ...
         Store_Word (Params, 0, Offset_Within_Area'Pos (Locator.Offset));
      end if;
   ...
   begin
      ...
      Store_Word (Params, 0, Word_Type (Const_Area) * 2**32 + Offset_Value);
   ...
   begin
      ...
      then
         ...
         --  Represent compile-time values by an offset in Const_Area
         Store_Word (Params, 0, Offset_Within_Area'Pos
   ...
   procedure Decl_Region
     (Context : Exec_Context;
      ...
      Region : Symbols.Region_Ptr :=
        Decl_Sem.Associated_Symbol.Nested_Region;
      use type Symbols.Region_Ptr;
   begin
   ...
   begin
      Store_Word
        (Params, 0,
         Code_Offset'Pos (Instr.Skip_Count));
   ...
   begin
      Store_Word
        (Params, 0,
         Routine_Index'Pos (Instr.Target_Index));
   ...
   begin
      Store_Word
        (Params, 0,
         Natural'Pos (Instr.Locked_Param_Info.Param_Index));
   ...
   begin
      ...
      Store_Word (Result +
        ...
        Code_Offset'Pos (Code.Pc_Offset));
      Store_Word (Result +
        Large_Obj_Header_Size + Offset_Within_Area'(1),
      ...
      Store_Word (Result +
        ...
        Offset_Within_Area'Pos (Code.Local_Area_Length));
      Store_Word (Result +
        Large_Obj_Header_Size + Offset_Within_Area'(4),
        Offset_Within_Area'Pos (Code.Start_Callee_Locals));
      Store_Word (Result +
        Large_Obj_Header_Size + Offset_Within_Area'(5),
        Code_Nesting_Level'Pos (Code.Nesting_Level));
   ...
   procedure Instruction_Assertion_Str
     (Context : Exec_Context;
      Params : Word_Ptr;
      Static_Link : Non_Op_Map_Type_Ptr) is
      --  func Assertion_Str(Instruction) -> Univ_String
   ...
   begin
      Store_Word
        (Params, 0,
         Strings.U_String_Index'Pos (Instr.Enum_Value));
   ...
   begin
      Store_Word
        (Params, 0,
         Code_Offset'Pos (Instr.Skip_If_False));
   ...
   begin
      Store_Word
        (Params, 0,
         Routine_Index'Pos (Instr.Parallel_Target_Index));
   ...
   begin
      Store_Word
        (Params, 0,
         Natural'Pos (Instr.Parallel_Locked_Param_Info.Param_Index));
   ...
   procedure Instruction_Num_Params
     (Context : Exec_Context;
      Params : Word_Ptr;
      Static_Link : Non_Op_Map_Type_Ptr) is
      --  func Num_Params(Instruction) -> Natural
      --    is import(#instruction_Num_Params)
      Instr_Index : constant Word_Type :=
        Fetch_Word (Params, 1);
      Instr : Instruction renames Nth_Instruction
        (Routine_Index (Instr_Index / 2**32),
   ...
   begin
      Store_Word
        (Params, 0,
         Natural'Pos (Instr.Num_Params));
   end Instruction_Num_Params;
   ...
   begin
      Store_Word
        (Params, 0,
         Code_Offset'Pos (Instr.Case_Default_Skip));
...
begin  --  PSC.Trees.Semantics.Translator;
   ...
   Interpreter.Builtins.Register_Builtin
     (Strings.String_Lookup ("#instruction_Num_Params"),
      Instruction_Num_Params'Access);
   Interpreter.Builtins.Register_Builtin
